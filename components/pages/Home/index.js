...
export const Home = function(){
    ...
    function applyFilter(){
        if(searchField && searchField.current && searchField.current.value && searchField.current.value !=""){
    ...
    return(
        <div>
            <HomePage
                ...
                paginationResult={bookDetails && bookDetails.data && bookDetails.data.length && checkForFilterResult()}
